...
public class JsoupLoginIteye {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jli.login("crazyacking", "passwd");//输入Iteye的用户名，和密码
    ...
    public void login(String userName, String pwd) throws Exception {
        ...
        //第一次请求
        Connection con = Jsoup.connect("https://passport.cnblogs.com/user/signin");//获取连接
         ...
         *
         * **/
        Connection con2 = Jsoup.connect("http://i.cnblogs.com/");
